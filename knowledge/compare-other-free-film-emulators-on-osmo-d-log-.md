---
id: compare-other-free-film-emulators-on-osmo-d-log-
kind: open
conflict-key: should-we-compare-other-free-film-emulators-on-osmo-d-log-
status: live
supersedes: []
proven: false
...
**Why it matters:** Ryan, 2026-09-16: 'we can use other film emulators. there are loads of free, high quality ways we can achieve the cinematic look. This is mostly just testing right now.' Without a comparison, the utility-dctls look (approved only on one iPhone clip) becomes the default for Osmo footage by inertia
